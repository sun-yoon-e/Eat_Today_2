...
class Japan_TableViewController: UITableViewController, XMLParserDelegate {
        ...
        if segue.identifier == "segueToDetail"{
            if let cell = sender as? UITableViewCell{
                ...
                if let japanDetailTableViewController = segue.destination as? Japan_DetailTableViewController{
                    japanDetailTableViewController.restNm = BIZPLC_NM
                }
                if let japanDetailTableViewController = segue.destination as? Japan_DetailTableViewController{
                    japanDetailTableViewController.lotAddr = REFINE_LOTNO_ADDR
                }
                if let japanDetailTableViewController = segue.destination as? Japan_DetailTableViewController{
                ...
                if let japanDetailTableViewController = segue.destination as? Japan_DetailTableViewController{
                    japanDetailTableViewController.REFINE_WGS84_LOGT = REFINE_WGS84_LOGT
                }
                if let japanDetailTableViewController = segue.destination as? Japan_DetailTableViewController{
                    japanDetailTableViewController.REFINE_WGS84_LAT = REFINE_WGS84_LAT
                }
