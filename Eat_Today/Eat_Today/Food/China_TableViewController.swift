...
class China_TableViewController: UITableViewController, XMLParserDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueToDetail"{
            if let cell = sender as? UITableViewCell{
                ...
                if let chinaDetailTableViewController = segue.destination as? China_DetailTableViewController{
                    chinaDetailTableViewController.REFINE_WGS84_LOGT = REFINE_WGS84_LOGT
                }
                if let chinaDetailTableViewController = segue.destination as? China_DetailTableViewController{
                    chinaDetailTableViewController.REFINE_WGS84_LAT = REFINE_WGS84_LAT
                }
